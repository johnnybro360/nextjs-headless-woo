      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-5 text-background/65 text-sm leading-relaxed">
              Small-batch artisan chilli sauces crafted with organic ingredients 
              and traditional fermentation methods since 2019.
            </p>
            {/* Social Links */}
          ...
          {/* Shop Links */}
          <div>
            <h3 className="mb-5 text-[11px] font-medium uppercase tracking-[0.18em] text-background/50">
              Shop
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/order-status" className="text-background/70 hover:text-background text-sm transition-colors">
                  Track order
                </Link>
              </li>
              <li>
